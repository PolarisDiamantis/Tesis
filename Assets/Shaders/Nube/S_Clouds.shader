...
Shader "S_Clouds"
{
	Properties
	{
		...
		[ASEEnd]_CloudIntensity("Cloud Intensity", Float) = 80
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float mulTime24 = _TimeParameters.x * _Speed;
				float2 temp_cast_2 = (mulTime24).xx;
				float2 texCoord14 = IN.ase_texcoord3.xy * rotatedValue17.xy + temp_cast_2;
				float simplePerlin2D10 = snoise( texCoord14*_NoiseScale );
				simplePerlin2D10 = simplePerlin2D10*0.5 + 0.5;
				float3 temp_cast_3 = (simplePerlin2D10).xxx;
